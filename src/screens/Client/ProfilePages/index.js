        ...
        return (
            <Container>
                ...
                <Header style={[S.BKLG, S.Jbetween, S.ROW, S.Acenter, S.headerStyle, S.MT20, S.MH10]}>
                    ...
                    <Entypo name="chevron-thin-left" onPress={()=>this.props.navigation.goBack()} size={12} color="#6B6864" />
                ...
                <Content style={[S.BKLG, S.P20, S.PT0]}>
                    ...
                    <View style={[S.MT20, S.MB40]}>
                        <TouchableOpacity style={[S.ROW, S.Acenter, S.Jbetween, {paddingVertical: 10, borderBottomColor: '#F2F3F4', borderBottomWidth: 1}]} onPress={()=>navigate("PersonalInfoScreen")}>
                        ...
                        <TouchableOpacity style={[S.ROW, S.Acenter, S.Jbetween, {paddingVertical: 10, borderBottomColor: '#F2F3F4', borderBottomWidth: 1}]} onPress={()=>navigate("PaymentInformationScreen")}>
                            <View style={[S.ROW, S.Acenter]}>
                        ...
                        <TouchableOpacity style={[S.ROW, S.Acenter, S.Jbetween, {paddingVertical: 10, borderBottomColor: '#F2F3F4', borderBottomWidth: 1}]} onPress={()=>navigate("PaymentHistoryScreen")}>
                            <View style={[S.ROW, S.Acenter]}>
                        ...
                        <TouchableOpacity style={[S.ROW, S.Acenter, S.Jbetween, {paddingVertical: 10, borderBottomColor: '#F2F3F4', borderBottomWidth: 1}]} onPress={()=>navigate("RedeemScreen")}>
                            <View style={[S.ROW, S.Acenter]}>
                        ...
                        <TouchableOpacity style={[S.ROW, S.Acenter, S.Jbetween, {paddingVertical: 10, borderBottomColor: '#F2F3F4', borderBottomWidth: 1}]} onPress={()=>navigate("TaskHistoryScreen")}>
                            <View style={[S.ROW, S.Acenter]}>
                        ...
                        <TouchableOpacity style={[S.ROW, S.Acenter, S.Jbetween, {paddingVertical: 10}]}>
                            <View style={[S.ROW, S.Acenter]}>
                ...
                <Footer style={[S.BKW, {height: normalize(60), borderTopWidth: 0}]}>
                    <FooterTab style={[S.BKW, S.Jbetween, {borderTopWidth: 0}]}>
                        ...
                        <Button style={S.BKPGR, {borderRadius: 50, alignItems:'center'}} onPress={()=>navigate('TaskIndicator')}>
                        ...
                        {
                            this.props.navigation.state.routeName === "ProfileScreen" ?
                            <View style={[S.activeFooterTab]}>
